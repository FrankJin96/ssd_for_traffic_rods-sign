# -*- coding: utf-8 -*-
"""
Created on Fri Mar 16 15:39:11 2018
...
def SSD300v2(input_shape, num_classes=21):
    ...
    conv4_2_norm = Normalize(20, name='conv4_2_norm')(conv4_2)
    conv4_2_norm_mbox_loc = Conv2D(num_priors * 4, (3, 3),
                                   name='conv4_2_norm_mbox_loc',
                                   padding='same')(conv4_2_norm)
    conv4_2_norm_mbox_loc_flat = Flatten(name='conv4_2_norm_mbox_loc_flat')(conv4_2_norm_mbox_loc)
    conv4_2_norm_mbox_conf = Conv2D(num_priors * num_classes, (3, 3),
                                    name=name,
                                    padding='same')(conv4_2_norm)
    conv4_2_norm_mbox_conf_flat = Flatten(name='conv4_2_norm_mbox_conf_flat')(conv4_2_norm_mbox_conf)
    conv4_2_norm_mbox_priorbox = PriorBox(img_size, 30.0,
                                          name='conv4_2_norm_mbox_priorbox',
                                          aspect_ratios=[2],  #这里为什么只有2？
                                          variances=[0.1, 0.1, 0.2, 0.2])(conv4_2_norm)
...
#                                     aspect_ratios=[4, 8],
    ...
    mbox_loc = concatenate([conv4_2_norm_mbox_loc_flat,
                            fc7_mbox_loc_flat,
                           ...
                           axis=1,
                           name='mbox_loc')
    mbox_conf = concatenate([conv4_2_norm_mbox_conf_flat,
                             fc7_mbox_conf_flat,
                            ...
                            axis=1,
                            name='mbox_conf')
    mbox_priorbox = concatenate([conv4_2_norm_mbox_priorbox,
                                 fc7_mbox_priorbox,
